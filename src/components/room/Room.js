                ...
                <div className="flex">
                        ...
                        <div className="player1">
                            <div>
                                ...
                                <div className="cards1">
                                    <div className="card 1p1">1card3p</div>
                                    <div className="card 1p2">2card3p</div>
                                    <div className="card 1p3">3card3p</div>
                                    <div className="card 1p4">4card3p</div>
                                </div>
                            </div>
                    ...
                    <div className="team1">
                        <div className="player3">
                            <div>
                              <div className="cards1">
                                  <div className="card 3p1">1card1p</div>
                                  <div className="card 3p2">2card1p</div>
                                  <div className="card 3p3">3card1p</div>
                                  <div className="card 3p4">4card1p</div>
                              </div>
